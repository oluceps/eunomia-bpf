...
extern "C" {
    ...
    pub fn open_eunomia_skel_from_json(
        ...
        object_size: size_t,
        btf_archive_path: *mut ::std::os::raw::c_char,
    ) -> *mut eunomia_bpf;
}
extern "C" {
    #[doc = " create a new eunomia bpf program from a json file"]
...
extern "C" {
    #[doc = " create a new eunomia bpf program from a json with btf archive"]
    pub fn open_eunomia_skel_from_json_package_with_btf(
        json_data: *const ::std::os::raw::c_char,
        btf_archive_path: *mut ::std::os::raw::c_char,
    ) -> *mut eunomia_bpf;
}
extern "C" {
    #[doc = " create a new eunomia bpf program from a json with args"]
